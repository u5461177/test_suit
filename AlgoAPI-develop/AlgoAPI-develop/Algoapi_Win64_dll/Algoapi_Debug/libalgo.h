...
namespace ALGO {
	namespace API {
		struct Algoapi {
			...
			bool issubcribedtask = false;
			bool issubcribedtrade = false;
			bool issubcribedorder = false;
			bool issubcribedminute = false;
			...
			virtual std::string
				start_twap(const std::string &start_time, const std::string &end_time, const std::string &ticker,
					...
					int minimal_trade_quantity, uint64_t _id = 0) = 0;

			virtual std::string
				start_vwap(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					const MARKET &market, const std::string &business_type, int quantity, int minimal_trade_quantity, uint64_t _id = 0) = 0;
			...
			virtual std::string
				start_iceberg(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					const MARKET &market, const std::string &business_type, int quantity, int visible_volume, uint64_t _id = 0) = 0;
			...
			virtual std::string
				start_amount_vwap(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					const MARKET &market, const std::string &business_type, double amount, int minimal_trade_amount, uint64_t _id = 0) = 0;
			...
			virtual std::string
				start_amount_pov(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					...
					double participation_rate, int minimal_trade_amount, uint64_t _id = 0) = 0;
			...
			virtual std::string
				start_amount_random(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					...
					int minimal_trade_amount, uint64_t _id = 0) = 0;

			virtual std::string
				start_amount_iceberg(const std::string &start_time, const std::string &end_time, const std::string &ticker, const SIDE &side,
					const MARKET &market, const std::string &business_type, double amount, double visible_amount, uint64_t _id = 0) = 0;

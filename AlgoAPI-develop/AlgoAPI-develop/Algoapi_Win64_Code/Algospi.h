...
namespace ALGO {
	namespace API {
		...
		public:
			...
			virtual void on_taskid(const string &jsonstr) = 0;

			virtual void on_subscribe_result(const string &jsonstr) = 0;

			virtual void on_unsubscribe_result(const string &jsonstr) = 0;

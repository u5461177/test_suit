...
namespace ALGO {
	namespace API {
		...
		void AlgoapiOri::pre_handle_message(const string &jsonstr) {
			...
			else if (report_type == "task_id_report") {
				_algospi->on_taskid(jsonstr2);
			}
			else if (report_type == "subscribe_result") {
				_algospi->on_subscribe_result(jsonstr2);
				_subscribe_type = param["subscribe_type"].get<string>();
				if (_subscribe_type == "subscribe_task_report_result") {
					issubcribedtask = true;
				}
				else if (_subscribe_type == "subscribe_order_report_result") {
					issubcribedorder = true;
				}		
				else if (_subscribe_type == "subscribe_trade_report_result") {
					issubcribedtrade = true;
				}
				else if (_subscribe_type == "subscribe_minute_report_result") {
					issubcribedminute = true;
				}
			}
			else if (report_type == "unsubscribe_result") {
				_algospi->on_unsubscribe_result(jsonstr2);
			}
			else {
		...
		string
			AlgoapiOri::start_vwap(const string &start_time, const string &end_time, const string &ticker, const SIDE &side,
				...
				int minimal_trade_quantity, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
		...
		string
			AlgoapiOri::start_is(const string &start_time, const string &end_time, const string &ticker, const SIDE &side,
				const MARKET &market, const string &business_type, int quantity, int minimal_trade_quantity, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
			jsonstr["start_time"] = start_time;
			jsonstr["end_time"] = end_time;
		...
		string
			AlgoapiOri::start_iceberg(const string &start_time, const string &end_time, const string &ticker, const SIDE &side,
				const MARKET &market, const string &business_type, int quantity, int visible_volume, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
			jsonstr["start_time"] = start_time;
			jsonstr["end_time"] = end_time;
		...
		string
			AlgoapiOri::start_amount_vwap(const string &start_time, const string &end_time, const string &ticker,
				...
				int minimal_trade_amount, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
			jsonstr["start_time"] = start_time;
			jsonstr["end_time"] = end_time;
		...
		string
			AlgoapiOri::start_amount_iceberg(const string &start_time, const string &end_time, const string &ticker,
				const SIDE &side,
				const MARKET &market, const string &business_type, double amount,
				double visible_amount, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
			jsonstr["start_time"] = start_time;
			jsonstr["end_time"] = end_time;
		...
		string
			AlgoapiOri::start_amount_ai(const string &start_time, const string &end_time, const string &ticker, const SIDE &side,
				const MARKET &market, const string &business_type, double amount, int minimal_trade_amount, uint64_t _id) {
			json jsonstr;
			jsonstr["id"] = _id;
			jsonstr["start_time"] = start_time;
			jsonstr["end_time"] = end_time;

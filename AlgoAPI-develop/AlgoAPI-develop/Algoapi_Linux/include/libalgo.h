...
namespace ALGO {
	namespace API {
		struct Algoapi {
			...
			static Algoapi *create(std::shared_ptr<Algospi> algospi, const std::string &algo_ip, int algo_port,
                                   const std::string &ws_ip, int ws_port);

			virtual void connect(const std::string &xtp_ip, int xtp_port, const std::string &username,

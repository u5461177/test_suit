...
static inline Tensor as_strided(const Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset=c10::nullopt);
static inline Tensor & as_strided_(Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset=c10::nullopt);
...
static inline Tensor var(const Tensor & self, IntList dim, bool unbiased=true, bool keepdim=false);
static inline Tensor & var_out(Tensor & result, const Tensor & self, IntList dim, bool unbiased=true, bool keepdim=false);
...
static inline Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype);
static inline Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim=false);
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype);
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim=false);
...
static inline Tensor & cholesky_solve_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper=false);
...
static inline std::tuple<Tensor &,Tensor &> fractional_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples);
static inline std::tuple<Tensor,Tensor> fractional_max_pool3d(const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples);
static inline Tensor & fractional_max_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices);
static inline Tensor fractional_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices);
...
static inline Tensor as_strided(const Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) {
    return detail::infer_type(self).as_strided(self, size, stride, storage_offset);
}
static inline Tensor & as_strided_(Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) {
...
static inline Tensor one_hot(const Tensor & self, int64_t num_classes) {
    return at::getNonVariableType(at::Backend::Undefined, at::ScalarType::Float).one_hot(self, num_classes);
}
static inline Tensor flip(const Tensor & self, IntList dims) {
...
static inline Tensor var(const Tensor & self, IntList dim, bool unbiased, bool keepdim) {
    return detail::infer_type(self).var(self, dim, unbiased, keepdim);
}
static inline Tensor & var_out(Tensor & result, const Tensor & self, IntList dim, bool unbiased, bool keepdim) {
...
static inline Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) {
    return detail::infer_type(self).norm(self, p, dim, keepdim);
}
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) {
    return detail::infer_type(self).norm_out(result, self, p, dim, keepdim, dtype);
}
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) {
...
static inline Tensor & cholesky_solve_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) {
    return detail::infer_type(self).cholesky_solve_out(result, self, input2, upper);
}

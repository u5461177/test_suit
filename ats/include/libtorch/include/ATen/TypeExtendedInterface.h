...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual Tensor empty_strided(IntList size, IntList stride, const TensorOptions & options) const = 0;
  ...
  virtual Tensor & var_out(Tensor & result, const Tensor & self, IntList dim, bool unbiased, bool keepdim) const = 0;
  ...
  virtual Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) const = 0;
  virtual Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) const = 0;
  ...
  virtual Tensor & cholesky_solve_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) const = 0;
  ...
  virtual std::tuple<Tensor &,Tensor &> fractional_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const = 0;
  virtual std::tuple<Tensor,Tensor> fractional_max_pool3d(const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const = 0;
  virtual Tensor & fractional_max_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const = 0;
  virtual Tensor fractional_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const = 0;

...
struct CAFFE2_API TypeDefault : public TypeExtendedInterface {
  ...
  Tensor as_strided(const Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) const override;
  Tensor & as_strided_(Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) const override;
  ...
  Tensor empty_strided(IntList size, IntList stride, const TensorOptions & options) const override;
  ...
  Tensor sum_to_size(const Tensor & self, IntList size) const override;
  ...
  Tensor var(const Tensor & self, IntList dim, bool unbiased, bool keepdim) const override;
  Tensor & var_out(Tensor & result, const Tensor & self, IntList dim, bool unbiased, bool keepdim) const override;
  ...
  Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) const override;
  Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) const override;
  Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) const override;
  Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) const override;
  ...
  Tensor & cholesky_solve_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) const override;
  ...
  std::tuple<Tensor &,Tensor &> fractional_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const override;
  std::tuple<Tensor,Tensor> fractional_max_pool3d(const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const override;
  Tensor & fractional_max_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const override;
  Tensor fractional_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const override;

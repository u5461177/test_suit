...
inline Tensor dispatch_as_strided(Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) {
...
inline Tensor dispatch_norm(Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) {

  AutoNoGIL no_gil;
  return self.norm(p, dim, keepdim, dtype);
}
inline Tensor dispatch_norm(Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) {
...
inline Tensor dispatch_std(Tensor & self, IntList dim, bool unbiased, bool keepdim) {
...
inline Tensor dispatch_sum_to_size(Tensor & self, IntList size) {
...
inline Tensor dispatch_var(Tensor & self, IntList dim, bool unbiased, bool keepdim) {

...
inline Tensor dispatch_as_strided(const Tensor & self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) {

  AutoNoGIL no_gil;
  return self.as_strided(size, stride, storage_offset);
}
inline Tensor dispatch_as_strided_(Tensor self, IntList size, IntList stride, c10::optional<int64_t> storage_offset) {
...
inline Tensor dispatch_cholesky_solve(const Tensor & self, const Tensor & input2, bool upper, Tensor result) {

  AutoNoGIL no_gil;
  return at::cholesky_solve_out(result, self, input2, upper);
}
...
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype, Tensor result) {

  AutoNoGIL no_gil;
  return at::norm_out(result, self, p, dim, keepdim, dtype);
}
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, ScalarType dtype) {

  AutoNoGIL no_gil;
  return self.norm(p, dim, keepdim, dtype);
}
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim, Tensor result) {

  AutoNoGIL no_gil;
  return at::norm_out(result, self, p, dim, keepdim);
}
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, IntList dim, bool keepdim) {
...
inline Tensor dispatch_var(const Tensor & self, IntList dim, bool unbiased, bool keepdim, Tensor result) {

  AutoNoGIL no_gil;
  return at::var_out(result, self, dim, unbiased, keepdim);
}
inline Tensor dispatch_var(const Tensor & self, IntList dim, bool unbiased, bool keepdim) {

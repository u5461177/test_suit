...
class CAFFE2_API ModelDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:torch.ModelDef) */ {
 public:
  ...
  // optional .torch.RecordRef model_metadata = 6;
  bool has_model_metadata() const;
  void clear_model_metadata();
  static const int kModelMetadataFieldNumber = 6;
  const ::torch::RecordRef& model_metadata() const;
  ::torch::RecordRef* release_model_metadata();
  ::torch::RecordRef* mutable_model_metadata();
  void set_allocated_model_metadata(::torch::RecordRef* model_metadata);
 ...
 private:
  ...
  void set_has_model_metadata();
  void clear_has_model_metadata();
  ...
  ::torch::RecordRef* model_metadata_;
...
// optional .torch.RecordRef model_metadata = 6;
inline bool ModelDef::has_model_metadata() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ModelDef::set_has_model_metadata() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ModelDef::clear_has_model_metadata() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ModelDef::clear_model_metadata() {
  if (model_metadata_ != NULL) model_metadata_->Clear();
  clear_has_model_metadata();
}
inline const ::torch::RecordRef& ModelDef::model_metadata() const {
  const ::torch::RecordRef* p = model_metadata_;
  // @@protoc_insertion_point(field_get:torch.ModelDef.model_metadata)
  return p != NULL ? *p : *reinterpret_cast<const ::torch::RecordRef*>(
      &::torch::_RecordRef_default_instance_);
}
inline ::torch::RecordRef* ModelDef::release_model_metadata() {
  // @@protoc_insertion_point(field_release:torch.ModelDef.model_metadata)
  clear_has_model_metadata();
  ::torch::RecordRef* temp = model_metadata_;
  model_metadata_ = NULL;
  return temp;
}
inline ::torch::RecordRef* ModelDef::mutable_model_metadata() {
  set_has_model_metadata();
  if (model_metadata_ == NULL) {
    model_metadata_ = new ::torch::RecordRef;
  }
  // @@protoc_insertion_point(field_mutable:torch.ModelDef.model_metadata)
  return model_metadata_;
}
inline void ModelDef::set_allocated_model_metadata(::torch::RecordRef* model_metadata) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  if (model_metadata) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      model_metadata = ::google::protobuf::internal::GetOwnedMessage(
  ...
  // @@protoc_insertion_point(field_set_allocated:torch.ModelDef.model_metadata)
}
